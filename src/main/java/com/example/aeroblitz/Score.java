...
public class Score {
    ...
    public void draw(GraphicsContext gc) {
        ...
        gc.setStroke(Color.DIMGREY);
        gc.setFont(Font.font("Consolas", 60));
        gc.strokeText(String.valueOf(player1 / 10) + String.valueOf(player1 % 10), 50, 82);

        // Draw player 2 score on the right side
        gc.strokeText((player2 / 10) + String.valueOf(player2 % 10), GAME_WIDTH - 120, 85);
    ...
    private void drawTimer(GraphicsContext gc, int timeSeconds) {
        ...
        gc.fillRect((GAME_WIDTH / 2) - 50, 530, 100, 80);
        ...
        gc.strokeText(String.format("%02d", timeSeconds), (GAME_WIDTH / 2) - 30, 570);
    }
